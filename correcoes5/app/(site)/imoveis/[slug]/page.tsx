  ...
  return (
    <main id="primary" className="site-main" role="main">
      ...
      <section className="imovel-hero">
        {/*
          Muitas fotos enviadas pelo painel são verticais (ex.: 1024x1280).
          Esticá-las na largura toda deixava a capa borrada e mal enquadrada.

          Solução em duas camadas:
           - fundo: a própria foto ampliada e desfocada, só para preencher
           - frente: a foto nítida, inteira, encostada à direita do texto
        */}
        <div className="imovel-hero-fundo" aria-hidden="true">
          <Image src={imovel.imagem} alt="" fill priority sizes="100vw" style={{ objectFit: 'cover' }} />
        </div>
        <div className="imovel-hero-foto">
          <Image
            src={imovel.imagem}
            alt={imovel.titulo}
            fill
