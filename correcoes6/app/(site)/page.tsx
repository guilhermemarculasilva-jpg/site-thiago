          ...
          <div className="container">
            <div className="hero-inner">
              <div className="hero-text">
                ...
                {/*
                  O <br/> fixo obrigava a quebra sempre no mesmo ponto, o que
                  criava linhas órfãs ("COM" sozinho) e fazia o leitor de tela
                  ler "É Investir comSucesso!" sem espaço.
                  Com espaço real + text-wrap: balance o navegador escolhe a
                  melhor quebra para cada largura.
                */}
