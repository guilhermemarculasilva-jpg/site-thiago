...
export default function Header() {
  ...
  // A tecla Esc fecha o menu do celular.
  //
  // Sem isso, quem navega pelo teclado ficava preso: o menu cobria a tela
  // inteira e a rolagem do fundo continuava travada, sem saída pelo teclado.
  // Ao fechar, o foco volta para o botão do hambúrguer.
  useEffect(() => {
    if (!menuOpen) return;
        ...
        <div className="container">
          <div className="header-inner">
            ...
            <nav className="main-nav" id="site-navigation" role="navigation" aria-label="Menu Principal">
              <ul id="primary-menu">
                {NAV_LINKS.map((link) => (
                  <li key={link.href} className={ativo === link.href ? 'menu-item-ativo' : ''}>
                    <Link
                      href={link.href}
                      className={ativo === link.href ? 'ativo' : ''}
